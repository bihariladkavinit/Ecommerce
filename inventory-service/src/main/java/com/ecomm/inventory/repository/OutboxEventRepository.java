 ...
 * multiple instances of this service run concurrently (e.g. during a rolling
 * deployment), each instance claims a disjoint batch of rows — preventing
 * duplicate Kafka publishes from concurrent relays.
 *
...
public interface OutboxEventRepository extends JpaRepository<OutboxEvent, UUID> {
     ...
     * SKIP_LOCKED ensures concurrent relay instances don't double-process rows.
     */
