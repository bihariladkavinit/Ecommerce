 ...
 *   <li>{@code enable.idempotence=true} — broker-side dedup on retries</li>
 ...
 *   <li>{@code auto.offset.reset=earliest} — don't silently skip events
 *       on first startup</li>
 * </ul>
 */
@Configuration
public class KafkaConfig {
     ...
     * Offset committed only after the listener returns without exception —
     * i.e. after the DB transaction has committed.
     */
    @Bean
