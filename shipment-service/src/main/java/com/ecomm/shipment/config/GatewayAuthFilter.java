 ...
 * </ul>
 *
 * <p>These headers are only present on requests that passed through the Gateway.
 * Public tracking calls ({@code GET /shipments/track/**}) and actuator/Swagger
 * paths are permitted without them by {@link SecurityConfig}.
 *
 ...
 * shipment-service is not reachable directly from outside the cluster.
 */
@Slf4j
